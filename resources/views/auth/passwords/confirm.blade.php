...
<div class="min-h-[calc(100vh-80px)] flex items-center justify-center relative overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="absolute inset-0 z-0 pointer-events-none">
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-amber-600/10 rounded-full blur-[100px]"></div>
    </div>

    <div class="w-full max-w-md relative z-10">
        <!-- Logo / Header -->
        <div class="text-center mb-8">
            <h2 class="text-3xl font-extrabold text-white tracking-tight">Konfirmasi Keamanan</h2>
            <p class="text-slate-400 mt-2 font-light">Harap konfirmasi password Anda sebelum melanjutkan.</p>
        </div>
        ...
        <div class="bg-slate-800/40 backdrop-blur-2xl border border-slate-700/50 rounded-3xl shadow-2xl p-8">
            ...
            <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
                ...
                <div>
                    <label for="password" class="block text-slate-300 text-sm font-medium mb-2">Password Saat Ini</label>
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <button type="submit" 
                        class="bg-cyan-600 text-white font-bold py-3 px-6 rounded-xl hover:bg-cyan-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500 focus:ring-offset-slate-800 shadow-[0_0_20px_rgba(8,145,178,0.3)] hover:shadow-[0_0_30px_rgba(8,145,178,0.5)] transition-all duration-300 hover:-translate-y-0.5">
                        Konfirmasi Lanjut
                    </button>
                </div>
            </form>
